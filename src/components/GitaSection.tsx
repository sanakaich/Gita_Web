...
// Using standard anchor tag for preview stability. Replace with Link from 'react-router-dom' in production.
  ...
  return (
    <section className="relative w-full py-24  overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        {/* 2. Left Column: The Divine Portal Image */}
        <div className="relative group perspective-1000">
            
            {/* Rotating Golden Ring (Decorative) */}
        ...
        <div className="text-center lg:text-left space-y-8">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed max-w-xl mx-auto lg:mx-0 font-light">
                Discover the conversation that changed the course of history. 
                Amidst the chaos of war, find the silence of wisdom. 
                Explore the shlokas that decode the universe, duty, and the self.
            </p>

            <div className="pt-4 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <a href="/gita" className="group relative inline-flex items-center justify-center px-8 py-4 text-lg font-heading font-bold text-black transition-all duration-200 bg-primary font-pj rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 overflow-hidden">
